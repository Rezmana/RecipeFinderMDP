...
class AllergyAdapter(
    private val allergyList: List<AllergyModel>, // The list of allergies to display
    private val onAllergyCheckedChanged: (List<AllergyModel>) -> Unit // Callback to handle changes
